...
/*  modifier                                   key                          function               argument     */
  ...
  { Super,                                     XK_F10,                      spawn,                 SHCMD("brightd-ctl up 10")},
  { Super,                                     XK_F9,                       spawn,                 SHCMD("brightd-ctl down 10")},
  ...
  { Super | ShiftMask | ControlMask,           XK_m,                        setlayout,             {.v = &layouts[2]} },
  { Super | ShiftMask | ControlMask,           XK_g,                        setlayout,             {.v = &layouts[3]} },
